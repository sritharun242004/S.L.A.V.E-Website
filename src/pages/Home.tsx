...
import { 
  ...
  Globe, Train, Film, Compass, Heart, Sparkles
} from "lucide-react";
...
const Home = () => {
  ...
  const useCounterAnimation = (end: number, duration: number = 2500, suffix: string = "") => {
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10 py-20 md:py-28">
          <div className="grid lg:grid-cols-[55%,45%] gap-12 items-center max-w-[1500px] mx-auto">
            ...
            <div className="hidden lg:flex relative justify-center items-center p-16 min-h-[650px] max-w-[650px] mx-auto overflow-visible">
              ...
              >
                  <div 
                    className="absolute inset-[-20px] rounded-full z-[-1] animate-pulse-glow"
                    style={{
                  ...
                  <div 
                    className="w-[200px] h-[200px] rounded-[40px] p-10 flex items-center justify-center border-4 border-white/30 relative transition-all duration-400 hover:-translate-y-1 hover:scale-105 animate-float-rotate"
                    style={{
                      background: 'linear-gradient(135deg, #EF4444 0%, #DC2626 100%)',
                      boxShadow: '0 30px 80px rgba(239,68,68,0.4), 0 0 0 1px rgba(255,255,255,0.1)',
                      transformStyle: 'preserve-3d'
                    }}
                  >
                    <GraduationCap className="w-[100px] h-[100px] text-white" strokeWidth={1.5} />
                </div>
              </div>
              
              {/* Floating Stat Card 1 - Years */}
              <div 
                className="absolute rounded-2xl border-2 border-[rgba(0,85,164,0.12)] min-w-[180px] max-w-[220px] flex items-center gap-3.5 transition-all duration-400 hover:-translate-y-1 hover:shadow-[0_16px_48px_rgba(0,0,0,0.15)] z-20"
                style={{
                  top: '3%',
                  left: '-19%',
              ...
              >
                ...
                <div className="flex flex-col gap-0.5">
                  <div className="text-[22px] font-extrabold leading-tight text-[#0055A4]">
                    17+
                  </div>
                  <div className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#6B7280]">
                    {t('home.hero.stats.years')}
                  </div>
                </div>
              </div>

              {/* Floating Stat Card 2 - Partners */}
              <div 
                className="absolute rounded-2xl border-2 border-[rgba(0,85,164,0.12)] min-w-[180px] max-w-[220px] flex items-center gap-3.5 transition-all duration-400 hover:shadow-[0_16px_48px_rgba(0,0,0,0.15)] z-20"
                style={{
                  top: '37%',
                  left: '137%',
                  background: 'rgba(255,255,255,0.98)',
                  ...
                  boxShadow: '0 10px 40px rgba(0,0,0,0.12)',
                  padding: '18px 24px',
                  animation: 'floatCard2 8s ease-in-out 2s infinite'
                }}
              >
                <div 
                  className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{
                    background: 'linear-gradient(135deg, #D85D28, #C74E1D)',
                    boxShadow: '0 4px 12px rgba(216,93,40,0.25)'
                  }}
                >
                  <Building className="w-[22px] h-[22px] text-white" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <div className="text-[22px] font-extrabold leading-tight text-[#EF4444]">
                    6
                  </div>
                  <div className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#6B7280]">
                    {t('home.hero.stats.partners')}
                  </div>
                </div>
              </div>
              
              {/* Floating Stat Card 3 - Projects */}
              <div 
                className="absolute rounded-2xl border-2 border-[rgba(0,85,164,0.12)] min-w-[180px] max-w-[220px] flex items-center gap-3.5 transition-all duration-400 hover:shadow-[0_16px_48px_rgba(0,0,0,0.15)] z-20"
                style={{
                  top: '66%',
                  ...
                  boxShadow: '0 10px 40px rgba(0,0,0,0.12)',
                  padding: '18px 24px',
                  animation: 'floatCard4 7.5s ease-in-out 3s infinite'
                }}
              >
                <div 
                  className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                ...
                >
                  <Film className="w-[22px] h-[22px] text-white" />
                </div>
                <div className="flex flex-col gap-0.5">
                  <div className="text-[22px] font-extrabold leading-tight text-[#0055A4]">
                    2
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-6 fade-in-up">
                {[
                  { icon: GraduationCap, title: "Education", color: "#0055A4" },
                  { icon: Globe, title: "Culture", color: "#EF4444" },
                  { icon: Lightbulb, title: "Creativity", color: "#0055A4" },
                  { icon: Heart, title: "Sustainability", color: "#EF4444" }
                ].map((item, index) => {
                  const Icon = item.icon;
                  return (
                    <Card 
                      key={index}
                      className="p-6 bg-white border-2 border-gray-100 rounded-2xl hover:-translate-y-2 hover:shadow-lg transition-all duration-300"

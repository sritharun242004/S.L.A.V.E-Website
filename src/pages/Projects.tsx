...
import {
  ...
  Presentation, Building, UserCircle, Layers, Languages
} from "lucide-react";
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 fade-in-up">
              <div className="inline-block px-5 py-2 rounded-full bg-[rgba(0,85,164,0.1)] mb-5">
                <span className="text-xs font-semibold uppercase tracking-wider text-[#0055A4]">Our Areas</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#003D6B] mb-4">
                5 Project Groups
              </h2>
              <p className="text-xl text-[#6B7280] max-w-3xl mx-auto">
                Discover our multidisciplinary approach through these five key areas of action.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {projectGroups.map((group, index) => {
                ...
                return (
                  <Card
                    key={group.id}
                    className={`fade-in-up p-8 border-2 ${group.border} rounded-3xl hover:-translate-y-2 hover:shadow-xl transition-all duration-300 relative overflow-hidden group w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.34rem)]`}
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-transparent to-${group.color}/5 rounded-bl-[100px] -mr-8 -mt-8 transition-all group-hover:scale-110`} />
                    ...
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: `0 8px 25px ${group.color}40`
                      }}
                    >
                      <Icon className="w-8 h-8 text-white" />
                    </div>

                    <h3 className="text-xl font-bold text-[#003D6B] mb-4 leading-tight">
                      {t(`projects.groups.${group.id}.title`)}
                    </h3>

                    <p className="text-[#6B7280] leading-relaxed">
                      {t(`projects.groups.${group.id}.description`)}
                    </p>
                  </Card>
                );
              })}
      ...
      <section className="py-12 bg-[#F8F7F4] border-b border-gray-200">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-white border border-gray-200 shadow-sm">
            ...
            <span className="font-bold text-[#003D6B] tracking-wide uppercase text-sm">Featured Project: Les Rails du Temps</span>
          </div>
        </div>
      </section>
